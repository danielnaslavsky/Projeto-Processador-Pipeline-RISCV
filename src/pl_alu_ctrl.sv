...
module pl_alu_ctrl (
    ...
    always_comb begin
        case (ALUOp)
            always_comb begin
        case (ALUOp)
            // Load / Store -> Sempre força operação de ADD (4'd01) para calcular endereço
            // Toda a decodificação do Funct3 para o Load já é feita no Datapath (MEM)
            2'b00: Operation = 4'd01; 

            // Branch BEQ -> SUB
            2'b01: Operation = 4'd02; 

            // R-type: decodificar Funct
            2'b10: begin                
                case (Funct3)
            ...
            2'b11: begin 
                case (Funct3)
                    ...
                    3'h3: Operation = 4'd10; // SLTIU IMPLEMENTADO
                    3'h4: Operation = 4'd03; // XORI IMPLEMENTADO
                    default: Operation = 4'd01;
                endcase
            end
            default: Operation = 4'd01;
